...
PS: Виявили помилки або маєте пропозиції? Зв'яжіться за адресою borchgrevink@gmail.com"""
    ...
    "tig": {
        "title": "Multiple Choice Generator (Tigre)",
        "language": "Luget",
        "login_google": "Login with Google",
        "welcome": "Merhaba",
        "logout": "Logout",
        ...
        "settings": "Settings",
        "source": "Select Source:",
        "source_pdf": "Historie på Tvers (Book)",
        "source_ndla": "NDLA (Online)",
        "update_topics": "Update Topics",
        "topics_found": "{} topics found.",
        "select_topic": "Select Topic",
        "ndla_info": "Select topics and articles from NDLA below.",
        "ndla_expand": "Select NDLA Content",
        "selected_articles": "{} articles selected.",
        "no_articles": "No articles selected.",
        "num_questions": "Number of Questions",
        "num_options": "Number of Options",
        "multiple_correct": "Multiple Correct Answers (Max 2)",
        ...
        "admin_panel": "Show Admin Panel",
        "admin_header": "Admin: Results (from Database)",
        "admin_tools": "**Tools:**\n- [Open NDLA Database Viewer](http://localhost:8000/ndla_content_viewer.html) (Requires local server)",
        "select_user": "Select User for Details",
        "results_for": "Results for: {}",
        "total_quizzes": "Total Quizzes",
        "total_questions": "Total Questions",
